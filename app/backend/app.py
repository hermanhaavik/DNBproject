...
azure_credential = DefaultAzureCredential(exclude_shared_token_cache_credential = True,exclude_managed_identity_credential=True )
...
chat_approaches = {
    "rtr": ChatRetrieveThenReadApproach(search_client, AZURE_OPENAI_CHATGPT_DEPLOYMENT, KB_FIELDS_SOURCEPAGE, KB_FIELDS_CONTENT),
